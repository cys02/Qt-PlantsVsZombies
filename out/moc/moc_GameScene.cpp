...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GameScene::*)(QGraphicsSceneMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameScene::mouseMove)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GameScene::*)(QGraphicsSceneMouseEvent * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameScene::mousePress)) {
                *result = 1;
                return;
            }
        }
